 ...
 * 집중(FOCUS) 및 휴식(REST) 모드에 따라 색상이 변경되며, 60분 단위의 눈금과 숫자를 표시
 */
public class TimerView extends View {

    /**
     * 타이머 다이얼 조작 시 발생하는 이벤트를 처리하기 위한 인터페이스
     */
    public interface OnTimerDialListener {
        /**
         * 다이얼을 돌리는 동안 진행률이 변경될 때 호출
         * @param progress 현재 선택된 시간의 진행률 (0.0 ~ 1.0)
         */
        void onDialChanged(float progress);
        
        /**
         * 다이얼 조작을 마치고 손을 뗐을 때 최종 선택된 진행률을 전달
